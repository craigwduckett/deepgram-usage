...
import type { UsageData } from '../lib/deepgram';
          ...
          >
            {trend.positive ? (
              ...
              <svg
                ...
                role="img"
              >
                <title>Downward trend icon</title>
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  strokeWidth="2"
        ...
        <CardContent className="flex h-full items-center justify-center p-6 text-center">
          <div>
            <svg
              ...
              role="img"
            >
              <title>Empty state chart icon</title>
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
                strokeWidth="2"
          ...
          <UsageCard
            ...
            icon={
              <svg
                ...
                role="img"
              >
                <title>Daily Average icon</title>
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  strokeWidth="2"
          ...
          <div className="rounded-lg border bg-card/50 p-5">
            ...
            <div className="mb-2 h-2 w-full overflow-hidden rounded-full bg-primary/10">
              <div
                ...
                style={{
                  width: `${Math.min((usageData.hours / 100) * 100, 100)}%`,
                }}
              />
            </div>
            ...
            <div className="mt-6 flex flex-col gap-4 text-sm sm:flex-row sm:justify-between">
              <div>
                ...
                <p className="mt-1 text-lg font-medium">
                  {usageData.requestsCount.toLocaleString()}
                </p>
              </div>
              <div>
                <p className="text-muted-foreground">Avg. per Request</p>
                <p className="mt-1 text-lg font-medium">
                  {(usageData.hours / (usageData.requestsCount || 1)).toFixed(
                    4
                  )}{' '}
                  hours
                </p>
